...
public class PageDashboard extends javax.swing.JPanel {
        ...
        if (goals != null) {
            ...
            if (count > 0) {
                for (int i = count - 1; i >= 0; i--) {
                    Goal g = goals.get(i);
                    if (!(g.getIsSubGoal() == true) && !(g.getIsAbandoned()) && !(g.getIsAccomplished())) {
                        if (g instanceof AccrueGoal || g instanceof CountGoal) {
                            summaryPanel.add(new CardAccrueOrCountGoal(g,false, false, false, false));
                        } else if (g instanceof AtomicGoal) {
                            summaryPanel.add(new CardAtomicGoal(g, false, false, false, false));
                        } else if (g instanceof MultiAtomicGoal) {
                            summaryPanel.add(new CardMultiAtomicGoal(g, false, false, false, false));
                        }
                        numDisplayed++;
                    }
                }
    ...
    private void initComponents() {
        ...
        newGoalLabel.setText("Goals Dashboard");
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(header, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(5, 5, 5)
                .addComponent(summaryPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 578, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
