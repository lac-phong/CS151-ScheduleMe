...
public class PageAbandonedGoals extends javax.swing.JPanel {
        ...
        if (goals != null) {
            ...
            if (count > 0) {
                for (int i = count - 1; i >= 0; i--) {
                    Goal g = goals.get(i);
                    if (g.getIsSubGoal() == false && (g.getIsAbandoned())) {
                        if (g instanceof AccrueGoal || g instanceof CountGoal) {
                            summaryPanel.add(new CardAccrueOrCountGoal(g, false, false, false, true));
                        } else if (g instanceof AtomicGoal) {
                            summaryPanel.add(new CardAtomicGoal(g, false, false, false, true));
                        } else if (g instanceof MultiAtomicGoal) {
                            summaryPanel.add(new CardMultiAtomicGoal(g, false, false, false, true));
                        }
                        numDisplayed++;
                    }
                }
    ...
    private void initComponents() {
        ...
        newGoalLabel.setText("Abandoned Goals");
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(header, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(5, 5, 5)
                .addComponent(summaryPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 704, Short.MAX_VALUE)
                .addGap(18, 18, 18)
