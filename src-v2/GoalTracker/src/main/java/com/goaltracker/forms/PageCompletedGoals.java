...
public class PageCompletedGoals extends javax.swing.JPanel {
                ...
                for (int i = count - 1; i >= 0; i--) {
                    ...
                    if (g.getIsSubGoal() == false && !(g.getIsAbandoned()) && (g.getIsAccomplished())) {
                        if (g instanceof AccrueGoal || g instanceof CountGoal) {
                            summaryPanel.add(new CardAccrueOrCountGoal(g, false, true, false, false));
                        } else if (g instanceof AtomicGoal) {
                            summaryPanel.add(new CardAtomicGoal(g, false, true, false, false));
                        } else if (g instanceof MultiAtomicGoal) {
                            summaryPanel.add(new CardMultiAtomicGoal(g, false, true, false, false));
                        }
                        numDisplayed++;
                    }
                }
    ...
    private void initComponents() {
        ...
        newGoalLabel.setText("Completed Goals");
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(header, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(5, 5, 5)
                .addComponent(summaryPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 839, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
